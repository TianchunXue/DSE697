...
from model_ctcf_v2 import BertMultiTaskForCTCF
...
MODEL_SAVE_PATH = "../checkpoints/best_model_v2.pt"
...
for epoch in range(MAX_EPOCHS):
    ...
    for step, batch in enumerate(pbar):
        ...
        labels = batch["labels"][:, 1:-1].to(device)  # align with token_logits shape
